								...
								<div class="row">
									 ...
									 <form>
										 ...
										 <table>
											 ...
											 <tr class="table-sun">
												 ...
												 <td colspan="3"><input class="form-control" name="subject" type="text" placeholder="휴점명을 입력해주세요." data-required="true"></td>
											 </tr>
											 <tr>
												 <th>브랜드</th>
								 ...
								 <div class="row">
									 ...
									 <div class="col-sm-2">
										 ...
										 <button type="button" class="btn btn-outline-primary btn-delete" onclick="location.href='/us/rest/listView'">취소</button>
									 </div>
									 <div class="col-sm-5"></div>
								 </div>
