								...
								<div class="row">
								 ...
								 <div class="col-12 col-lg-12">
									 <table>
										 ...
										 <tr class="table-sun">
											 <th>휴점명</th>
											 <td colspan="3"><input class="form-control" name="subject" type="text" placeholder="제목을 입력해주세요."></td>
										 </tr>
										 <tr>
											 <th>브랜드</th>
											 <td></td>
										 ...
										 <tr>
											 ...
											 <td colspan="3">
												 <div class="inline-layout">
													 <span>시작일</span><span>*</span> <input class="form-control" type="date" id="start_date" name="start_date"/> <span>~</span>
													 <span>종료일</span><span>*</span> <input class="form-control" type="date" id="end_date" name="end_date"/>
												 </div>
											 </td>
										 </tr>
										 <tr>
