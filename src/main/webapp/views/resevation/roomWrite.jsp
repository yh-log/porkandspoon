            ...
            <div class="col-12 col-lg-12">
               ...
               <div class="cont-body"> 
                  ...
                  <!-- <div class="col-6 col-lg-6">
                  	<div class="write-form-3">
                  		<h5>등록자</h5>
                  		<h5 style="margin-left: 68px;">김진형</h5>
                  	</div>
                  	<div class="write-form">
                  		<h5>회의실 명</h5>
                  		<input class="form-control sor-1" type="text"/>
                  	</div>
                  	<div class="write-form">
                  		<h5>수용 인원</h5>
                  		<input class="form-control sor-1" type="text"/>
                  	...
                  	<div class="write-form">
                  		<h5>내용</h5>
                  		<textarea class="form-control art"></textarea>
                  	</div>
                  	<div class="write-form1">
                  		<h5>활성상태</h5>
                  		<div class="write-form2">
                  			<div class="btn btn-primary">활성화</div>
                  			<div class="btn btn-primary">비활성화</div>
                  		</div>
                  	</div>
                  	<div class="btn-room">
