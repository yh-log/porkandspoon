                  ...
                  <div class="col-12 col-lg-12">
	                  <table class="align-l">
	                  	...
	                  	<tr>
	                  		<th>카테고리</th>
	                  		<td>
	                  			<select class="form-input1">
	                  				<option value="">의무 교육</option>
	                  				<option value="">직무 교육</option>
	                  				<option value="">위생 교육</option>
	                  				<option value="">운영 교육</option>
	                  			</select>
	                  		</td>
	                  	</tr>
	                  	<tr>
	                  	...
	                  	<tr>
	                  		<th>영상 첨부</th>
							<td>
		                        <input id="youtube-url" class="form-control sor-1" type="text" name="url" placeholder="유튜브 동영상 URL을 입력하세요"/>
               	...
               	<div class="col-12 col-lg-12">
               		<div class="btn-room">
		           		<div class="btn btn-primary" onclick="roomWrite()">등록하기</div>
...
$(document).ready(function(){
    $('#youtube-url').on('input', function() {
        ...
        if(videoId){
            ...
            var iframe = `<iframe width="1250" height="703" src="${embedUrl}" 
                            title="유튜브 동영상" 
                            frameborder="0" 
