	               ...
	               <p id="currentUser" style="display:none;"><sec:authentication property="principal.username"/></p>
		                  <table>
							...
							<tbody>
								...
								<tr class="table-sun" id="user-dept-insert">
									<th class="table-text table-text-text">부서</th>
									<td class="table-text"></td>
								</tr>
								<tr class="table-sun">
									<th class="table-text table-text-text">제목</th>
									<td class="table-text"><input class="form-control" name="subject" type="text" placeholder="제목을 입력해주세요."></td>
								</tr>
								<tr>
...
<script>
	...
	function httpSuccess(response) {
		...
		if(response.status === 'username') {
			 ...
			 $('#user-dept-insert td').text(response.text);
		}
	}
